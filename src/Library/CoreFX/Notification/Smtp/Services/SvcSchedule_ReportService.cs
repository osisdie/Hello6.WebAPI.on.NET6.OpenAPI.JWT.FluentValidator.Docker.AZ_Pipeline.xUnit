...
using CoreFX.Notification.Smtp.Utils;
using Microsoft.Extensions.Logging;
using Microsoft.Extensions.Options;

namespace CoreFX.Notification.Smtp.Services
{
            ...
            where T : class, IReportDecordDto
    {
        ...
        public SvcSchedule_ReportService(ILogger<SvcSchedule_ReportService<T>> logger,
